    ...
    return (
        <div className="bg-white font-sans p-8 mb-14 rounded-xl max-w-7xl mx-auto">
            <div className="space-y-8">
                ...
                <div className='flex lg:flex-row flex-col p-5 lg:p-0  justify-between  items-center gap-8'>
                    <div className='space-y-5'>
                        ...
                        <div className="flex w-full">
                            <input
                                ...
                                className="flex-1 px-4 py-3 focus:outline-none bg-gray-50 border border-gray-300 rounded-l-lg     text-gray-700"
                            />
                            <button
